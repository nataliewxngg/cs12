...
public class L3_MsWong1_SortByFirstName implements Comparable<L3_MsWong1_SortByFirstName> {

    public int compareTo(L3_MsWong1_SortByFirstName w) {
        return this.getFirstName().compareTo(w.getFirstName()); // ASCENDING ORDER (A-Z)
        // return w.getFirstName().compareTo(this.getFirstName()); // DESCENDING ORDER
    }
    ...
    // - can overload
    public L3_MsWong1_SortByFirstName(String firstName, String subject, int age) {
        this.firstName = firstName;
        this.subject = subject;
        this.age = age;
    }

    public L3_MsWong1_SortByFirstName(String firstName) { // Overloaded constructor
        this.firstName = firstName;
    }
    ...
    public boolean sameName(L3_MsWong1_SortByFirstName o) {
        // L1_MsWong1 wong = (L1_MsWong1) o; // if parameter was Object o instead
        L3_MsWong1_SortByFirstName wong = o;
